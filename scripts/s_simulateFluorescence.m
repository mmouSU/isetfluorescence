...
flScene = fluorescentSceneCreate('height',4,'width',6,'wave',wave,'qe',1);         
...
predVals = reflValsRef + flValsRef;
...
%% Save data
save('simulation.mat','cameraGain','cameraOffset','measVals','reflRef','dMatRef','exRef','emRef','reflValsRef','flValsRef');

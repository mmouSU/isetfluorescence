...
%   For my own analyses and those we published, I (Joyce) chose to use the 
...
% Keratin -  Note that we measured Keratin powder fluorescence
...
% Keratin - not sure why the emission data are the same - check this
ieNewGraphWin;
chdir(fullfile(fiToolboxRootPath,'data','Keratin'));
Keratin = fiReadFluorophore('Keratin.mat','wave',theseWaves); 

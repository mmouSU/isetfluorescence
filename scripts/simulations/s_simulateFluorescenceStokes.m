...
for q=1:(length(stokesRanges)-1);
    ...
    flScene = fluorescentSceneCreate('height',height,'width',width,'wave',wave,'qe',flQe,'nFluorophores',nFluorophores,...
                                 ...
                                 'stokesShiftRange',[stokesRanges(q) stokesRanges(q+1)],...
                                 'dataSet',dataset);
    ...
    fName = fullfile(fiToolboxRootPath,'data','simulations',sprintf('%s_%ix%ix%i_stokes_%i.mat',dataset,height,width,nFluorophores,stokesRanges(q+1)));
